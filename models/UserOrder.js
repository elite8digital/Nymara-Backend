...
// 🔹 Indexes for better query performance and idempotency
userOrderSchema.index({ razorpayOrderId: 1 });
userOrderSchema.index({ razorpayPaymentId: 1 });
userOrderSchema.index({ userId: 1, paymentStatus: 1 });
